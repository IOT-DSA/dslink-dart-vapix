...
// Profiles
  ...
  prof.forEach((String key, Function val) {
    link.profiles.putIfAbsent(key, () => val);
  });
...
class DataRootNode extends SimpleNode {
  ...
  static const String isType = '$_linkName/data/root';
...
class DataNode extends SimpleNode {
  static const String isType = '$_linkName/data/node';
...
class DataAddNode extends SimpleNode {
  ...
  static const String isType = '$_linkName/data/addNode';
...
class DataAddValue extends SimpleNode {
  ...
  static const String isType = '$_linkName/data/addValue';
...
class DataPublish extends SimpleNode {
  ...
  static const String isType = '$_linkName/data/publish';
...
class DataRemove extends SimpleNode {
  ...
  static const String isType = '$_linkName/data/remove';
